    ...
    return (
        <main className="p-7">
            ...
            <div className={`mt-6 space-y-4 text-white text-lg ${spaceGroteskMedium.className}`}>
                ...
                <ul className="list-disc list-inside ml-4">
                    <li>YouTubers may post job listings for a one-time fee per post.</li>
                ...
                <h2 className={`text-2xl font-semibold ${bricolageGrotesqueBold.className}`}>5. Fees & Payments</h2>
                <ul className="list-disc list-inside ml-4">
                    <li>Job posting fees are charged per listing and are <strong>non-refundable</strong>.</li>
                    <li>Payments are processed via Paddle or any other third-party payment provider we may integrate in the future.</li>
                    <li>Crimson does not offer refunds except in cases of platform-related errors.</li>
                </ul>

                <h2 className={`text-2xl font-semibold ${bricolageGrotesqueBold.className}`}>6. Content & Conduct Guidelines</h2>
                <ul className="list-disc list-inside ml-4">
                ...
                <h2 className={`text-2xl font-semibold ${bricolageGrotesqueBold.className}`}>7. Liability & Disputes</h2>
                <ul className="list-disc list-inside ml-4">
                ...
                <h2 className={`text-2xl font-semibold ${bricolageGrotesqueBold.className}`}>8. Third-Party Services</h2>
                ...
                <h2 className={`text-2xl font-semibold ${bricolageGrotesqueBold.className}`}>9. Termination of Accounts</h2>
                <ul className="list-disc list-inside ml-4">
                ...
                <h2 className={`text-2xl font-semibold ${bricolageGrotesqueBold.className}`}>10. Governing Law & Jurisdiction</h2>
                ...
                <h2 className={`text-2xl font-semibold ${bricolageGrotesqueBold.className}`}>11. Changes to These Terms</h2>
